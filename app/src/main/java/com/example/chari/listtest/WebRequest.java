...
public class WebRequest
{
    ...
    public String makeWebServiceCall(String urladdress, int requestmethod,
        ...
        try {
            ...
            // Log.e(MainActivity.TAG," web log");
            ...
            int reqresponseCode = conn.getResponseCode(); //it will call after networl process
            ...
            if (reqresponseCode == HttpsURLConnection.HTTP_OK)
            {
                ...
                while ((line = br.readLine()) != null) {
                    response += line;
                    // Log.e(MainActivity.TAG,"respo in web"+response);
                }
            } else {
                response = "";
            }
